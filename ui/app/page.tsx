...
export default function WelcomeScreen() {
  ...
  const handleEnable = () => {
    // @ts-ignore
    window.electronAPI?.enableProxy();
  };

  const handleDisable = () => {
    // @ts-ignore
    window.electronAPI?.disableProxy();
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#a89cc8] via-[#b8a8d8] to-[#c4b5e0] relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-8 text-center">
        <div className="max-w-md mx-auto space-y-8">
          ...
          >
            <Button onClick={() => console.log("Apple Login")} className="w-full h-14 bg-[#2c2f5a]/10 backdrop-blur-sm border border-[#2c2f5a]/20 text-[#2c2f5a] hover:bg-[#2c2f5a]/20 transition-all duration-300 rounded-2xl text-lg font-light shadow-lg">
              <Apple className="w-5 h-5 mr-3" />
              Continue with Apple
            </Button>

            <Button onClick={() => console.log("Email Login")} className="w-full h-14 bg-gradient-to-r from-[#a0c4b4]/30 to-[#f1dce8]/30 backdrop-blur-sm border border-[#a0c4b4]/30 text-[#2c2f5a] hover:from-[#a0c4b4]/40 hover:to-[#f1dce8]/40 transition-all duration-300 rounded-2xl text-lg font-light shadow-lg">
